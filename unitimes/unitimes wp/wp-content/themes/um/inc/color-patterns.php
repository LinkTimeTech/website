...
function um_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'um_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.um-front-page) .entry-title,
...
.colors-custom .um-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.um-front-page .panel-content .recent-posts article,
...
.colors-custom.um-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'um_custom_colors_css', $css, $hue, $saturation );
}
