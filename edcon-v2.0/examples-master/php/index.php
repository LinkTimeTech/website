...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12">
            <p>
                <a href="https://github.com/omise/omise-php" target="_blank"><strong>OMISE-PHP</strong></a> is a library
                for connect with Omise Payment Gateway services (see more <a href="https://docs.omise.co/"
                                                                             target="_blank">https://docs.omise.co/</a>).
                <br/>So, all of files in this directory will show you about the best pratices that you should do when
                implementing <strong>omise-php</strong> into your project.
            </p>
        </div> <!-- /END .col-xs-12 -->
    </div> <!-- /END .row -->
    ...
    <ul>
        <li><a href="services/account.php">Retrieve the account</a> (see more from <a target="_blank"
                                                                                      href="https://docs.omise.co/api/account/#accounts-retrieve">https://docs.omise.co/api/account/#accounts-retrieve</a>)
        </li>
        <li><a href="services/balance.php">Retrieve the balance</a> (see more from <a target="_blank"
                                                                                      href="https://docs.omise.co/api/balance/#balances-retrieve">https://docs.omise.co/api/balance/#balances-retrieve</a>)
        </li>
        <li><a href="services/charge.php">List all charges</a> (see more from <a target="_blank"
                                                                                 href="https://docs.omise.co/api/charges/#charges-list">https://docs.omise.co/api/charges/#charges-list</a>)
        </li>
    </ul>
    ...
    <footer>
        <div class="row">
            <div class="col-xs-2">
                <a title="Omise Gateway" href="https://www.omise.co/"><img alt="Omise Payment"
